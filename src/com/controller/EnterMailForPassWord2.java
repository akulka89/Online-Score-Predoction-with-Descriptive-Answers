...
@WebServlet("/EnterMailForPassWord2")
public class EnterMailForPassWord2 extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int flage=DBConnnection.checkMailForPass2(email);
		String pass=DBConnnection.returnPassForReset2(email);
		...
		if(flage!=0)
		{
			...
			out.println("location='ResetPassword2.jsp';");
			out.println("</script>");	
		...
		}else
		{
			...
			out.println("location='enteremail2.jsp';");
			out.println("</script>");	
		}	
