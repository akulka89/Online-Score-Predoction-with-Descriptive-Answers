...
@WebServlet("/SendTestOnMail")
public class SendTestOnMail extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int tid=Integer.parseInt(session.getAttribute("testid3").toString());
		   ...
		   Document document = new Document();
			...
			String Email="vaibhav.kasnet@outlook.com";
			...
			try {
				...
				flage=1;
				System.out.println("Report Sended Successfully on mail...");
