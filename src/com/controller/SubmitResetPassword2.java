...
@WebServlet("/SubmitResetPassword2")
public class SubmitResetPassword2 extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int flage=DBConnnection.checkPass2(email,oldpass);
		PrintWriter out = response.getWriter();
		int flage31=0;
		if(flage!=0)
		{
			 flage31=DBConnnection.chnagepass2(email,newpass);	
