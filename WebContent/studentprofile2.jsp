...
<%
  ...
  Double percentage=DBConnnection.profilePercentage(id2);
				...
				<div class="container main-menu">
					<div class="row align-items-center justify-content-between d-flex">
				      ...
				      <nav id="nav-menu-container">
				        <ul class="nav-menu">
				          <li style="margin-left: 720px;"><a href="studentwelcome.jsp">Back</a></li>
...
<div class="container bootstrap snippet">
    ...
    <div class="row">
      ...
      <%
                        ...
                        UserRegisterModel obj= DBConnnection.getImg(id2);
    	...
    	<div class="col-sm-9">
            <ul class="nav nav-tabs">
                <li class="active"><a style="font-family: serif; font-size: 18px; color:black" data-toggle="tab" href="#home">Student Profile:</a></li>
                  ...
                  <form  action="StudentProfile" method="post" >
                      ...
                      <div class="form-group">
                          <div class="col-xs-6">
                             <label for="mobile"><h4>Mobile:</h4></label>
                              <input type="text" class="form-control" name="mobile" style="font-family: serif; font-size: 15px; color: snow; background-color: #000000a1;"  value="<%=s.getMobile()%>" id="mobile" placeholder="enter mobile number" title="enter your mobile number if any.">
                          </div>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-xs-6">
                              ...
                              <input type="text" class="form-control" name="city" style="font-family: serif; font-size: 15px; color: snow; background-color: #000000a1;" value="<%=s.getCity()%>" id="location" placeholder="Your City" title="enter a location">
                          </div>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                           <div class="col-xs-12">
                                <br>
                                <h3 style="font-family: sans-serif; font-size: 24px; color: snow; background-color: black;width: 291px;  ">Professional Information:</h3>
                              	</div>
                      </div>
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-xs-6">
                            <br><label for="password2"><h4>Qualification:</h4></label>
                              <input type="text" class="form-control" name="Qualification" style="font-family: serif; font-size: 15px; color: snow; background-color: #000000a1;" value="<%=s.getQualification()%>" id="password2" placeholder="Qualification" title="enter your password2.">
                          </div>
                      </div>
                      <div class="form-group">
                          
                          <div class="col-xs-6">
                            <br><label for="password2"><h4>Technical Intrest:</h4></label>
                              <input type="text" class="form-control" name="TI" style="font-family: serif; font-size: 15px; color: snow; background-color: #000000a1;" value="<%=s.getTI()%>" id="password2" placeholder="Technical Intrest" title="enter your password2.">
                          </div>
                      </div>
                      <div class="form-group">
                          ...
                          <div class="col-xs-6">
                            <label for="password2"><h4>Department:</h4></label>
                              <input type="text" class="form-control" name="Department" style="font-family: serif; font-size: 15px; color: snow; background-color: #000000a1;" value="<%=s.getDepartment()%>" id="password2" placeholder="Department" title="enter your password2.">
                          </div>
                      </div>
                      <div class="form-group">
                          
                          <div class="col-xs-6">
                            <label for="password2"><h4>Collage-Name:</h4></label>
                              <input type="text" class="form-control" name="CN" style="font-family: serif; font-size: 15px; color: snow; background-color: #000000a1;" value="<%=s.getCN()%>" id="password2" placeholder="Collage name" title="enter your password2.">
                          </div>
                      </div>
                      <div class="form-group">
                          
                          <div class="col-xs-6">
                            <label for="password2"><h4>Current-Address</h4></label>
                              <input type="text" class="form-control" name="CA"  style="font-family: serif; font-size: 15px; color: snow; background-color: #000000a1;" value="<%=s.getCA()%>"id="password2" placeholder="Current-Address" title="enter your password2." style="height: 60px">
                          </div>
                      </div>
                      <div class="form-group">
                          
                          <div class="col-xs-6">
                            <label for="password2"><h4>Parmanent-Address</h4></label>
                              <input type="text" class="form-control" name="PA" style="font-family: serif; font-size: 15px; color: snow; background-color: #000000a1;" value="<%=s.getPA()%>" id="password2" placeholder="parmanent address" title="enter your password2."style="height: 60px">
                          </div>
                      </div>
