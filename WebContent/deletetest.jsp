...
ArrayList<ArrayList> list=DBConnnection.gettestdata2(id);
...
%>	
        ...
        <tbody style="font-family: serif; font-size: 19px; color: snow;">
            ...
            <%	
						...
						for(int i=0;i<list.size();i++)
                         {
							...
							int tid=(int)list.get(i).get(0);
					        int totalquestion=DBConnnection.gettotalquestion(tid);
                  ...
                  <%
					...
					<td align="center"><span><%=totalquestion%></span></td>
					<form action="DeleteTestController" method="post"> 
					<td align="center">
					<button type="submit" name="dt" value="<%=list.get(i).get(0)%>">Delete Test</button>
