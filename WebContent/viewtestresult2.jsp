...
int id=(Integer)session.getAttribute("rtid");

ArrayList<Integer> al=DBConnnection.getuserid(id);
ArrayList<String> usernamelist=new ArrayList();

for(int i=0;i<al.size();i++)
{
	String uname=DBConnnection.getuname(Integer.parseInt(al.get(i).toString()));
	usernamelist.add(uname);
}



ArrayList<ArrayList> list=DBConnnection.getresultinfo(id,usernamelist);
